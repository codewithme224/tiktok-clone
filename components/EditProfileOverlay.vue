<template>
    ...
    >
        ...
        >
            ...
            <div class="absolute top-0 left-0 flex items-center justify-between w-full p-5 border-b border-b-gray-300">
            ...
            <div 
                id="ButtonSection" 
                class="absolute bottom-0 left-0 w-full p-5 border-t border-t-gray-300"
            >
                <div 

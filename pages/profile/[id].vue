<template>
    <MainLayout>
        ...
        class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
            <div class="flex w-[calc(100vw-230px)]">
                ...
                <div class="w-full ml-5">
                    ...
                    class="flex items-center rounded-md py-1.5 px-3.5 mt-3 text-[15px] font-semibold border hover:bg-gray-100">
                        <Icon name="clarity:edit-line" size="20" class="mr-2" />
            ...
            <div class="pt-4 mr-4 font-light text-gray-500 text-[15px] pl-1.5 max-w-[500px]">{{ $profileStore.bio }}</div>

            <div class="flex items-center w-full pt-4 border-b">
                <div class="py-2 text-center w-60 text-[17px] font-semibold border-b-2 border-b-black">
                    Videos
                </div>
                <div class="text-gray-500 py-2 text-center w-60 text-[17px] font-semibold">
                    <Icon name="material-symbols:lock-open" class="mb-0.5"/> Liked
                </div>
            </div>

            <div class="grid grid-cols-2 gap-3 mt-4 2xl:grid-cols-6 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3">

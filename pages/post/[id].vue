<template>
  <div 
      id="PostPage" 
      class="fixed top-0 left-0 z-50 justify-between w-full h-full overflow-auto bg-black lg:flex lg:overflow-hidden"
  >
      ...
      >
          ...
          >
              ...
              <div 
                  ...
                  class="mt-6 text-xl text-center text-gray-500"
              >
                  No comments...
              </div>
